...
<center><h2>Unverified Squirrel Sightings</h2></center>   
    

<table class="table table-hover">
<thead>
<tr><th>Species</th><th>Longitude</th><th>Latitude</th><th>Timestamp</th><th>Submitted By</th><th>Submitted Picture</th><th>Verify</th></tr>
</thead>
<tbody>
...
<tr>
  ...
  <td><button class="btn btn-info" id="${siting.id}">Accept</button> &nbsp; <button class="btn btn-warning" id="${siting.id}">Reject</button></td>
</tr>
</c:forEach>
</tbody>
</table>
