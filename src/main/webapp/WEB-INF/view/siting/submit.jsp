...
<form class="form-horizontal" role="form" id="siting" action="<c:url value='/service/siting/submit' />" method="post">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="longitude" class="form-control" id="inputLongitude" placeholder="">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="latitude" class="form-control" id="inputLatitude" placeholder="">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input id="timestamp" name="timestamp" placeholder="yyyy-MM-dd hh:mm:ss:SS" value="2013-09-19 08:50:00:00" class="form-control" >
    </div>
  </div>

  <div class="form-group">
    <label for="inputPicture" class="col-sm-2 control-label">Squirrel Picture</label>
     <div><input id="inputPicture" type="file" name="uploadedFile" size="50" ></div>
  </div>
