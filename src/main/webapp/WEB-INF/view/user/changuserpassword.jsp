...
<h3> Change User Password - ${user.username} </h3>

<form class="form-horizontal" role="form" action="<c:url value='/changepassword' />" method="post">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" name="edit" value="Edit" class="btn btn-default">Change Password</button>
    </div>
  </div>
